...
function About() {
  ...
  return (
    <div className="container">
      ...
      <div className="about-content py-5 px-5">
      <div className="about" id="about">
        ...
        <p>I am a life long techy, studied Physics, Maths and Electronics in my youth, I have had a fabulously diverse
          ...
          My carrer took a slight diversion from this path as I supported the business by taking over management of the IT infrastructure,
          tool management and endpoint management. Last year I had some life changing health issues which I overcame, and then decided that I wanted 
